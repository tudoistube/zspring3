function checkImageType(fileName){
	...
	console.log('checkImageType : ' + fileName.match(pattern));
...
function getFileInfo(fullName){
	...
	console.log('getFileInfo(fullName) :: fullName : ' + fullName);
	console.log('getFileInfo(fullName) :: getLink : ' + getLink);
	console.log('getFileInfo(fullName) :: fileName : ' + fileName);
