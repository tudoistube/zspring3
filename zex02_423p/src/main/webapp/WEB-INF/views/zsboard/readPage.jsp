...
<script>				
	$(document).ready(function(){
		...
		$(".btn-warning").on("click", function(){
			//formObj.attr("action", "/z2/zboard/update"); //...read.jsp, 298p.주석.
			//...수정화면으로 이동(get).
			formObj.attr("action", "/z2/zsboard/updatePage");
		...
		$(".btn-danger").on("click", function(){
			...
			formObj.attr("action", "/z2/zsboard/deletePage");
			formObj.submit();
		});
		
		$(".btn-primary").on("click", function(){
			//self.location = "/z2/zboard/listAll"; //...read.jsp, 294p 주석.
			
			//...294p.내용조회후 다시 원래 목록 위치로 돌아가기 위한 정보추가.
			formObj.attr("method", "get");
			formObj.attr("action", "/z2/zsboard/listPage");
			formObj.submit();		
		});
