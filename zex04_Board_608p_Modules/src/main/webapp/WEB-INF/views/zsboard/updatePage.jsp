...
$(document).ready(function() {
	...
	$(".btn-warning")
		.on("click", 
			 function() {
				/*...jstl변수 msg = "SUCCESS" 값이 들어와서 "처리되었습니다" 라는 메시지가 팝업되어 주석처리함.
...
<%@include file="../zinclude/zfileDrop.jsp"%>
<%@include file="../zinclude/zpopupImg.jsp"%>
<%@include file="../zinclude/zattachedImg.jsp"%>
