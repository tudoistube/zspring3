						...
						<c:forEach items="${list}" var="boardVO">
							...
							<tr>
								...
								...317p.								
								 -->
								<td>
									<a href='/z4b/zsboard/readPage${pageMaker.makeSearch(pageMaker.cri.page)}&bno=${boardVO.bno}'>
										${boardVO.title}
						...
						<ul class="pagination">
							...
							<c:if test="${pageMaker.prev}">
								...
								<!-- 
								 ...
								 -->
									<a href="/z4b/zsboard/listPage${pageMaker.makeSearch(pageMaker.startPage - 1) }">&laquo;</a>
								</li>
							</c:if>
							...
							<c:forEach begin="${pageMaker.startPage }"
								...
								<!-- 
									...
									...313p.↓.
								 -->
									<a href="/z4b/zsboard/listPage${pageMaker.makeSearch(idx)}">${idx}</a>
								</li>
							</c:forEach>
							...
							<c:if test="${pageMaker.next && pageMaker.endPage > 0}">
								...
								<!-- 
									...
									...313p.↓.
								 -->								
									<a href="/z4b/zsboard/listPage${pageMaker.makeSearch(pageMaker.endPage +1) }">&raquo;</a>
